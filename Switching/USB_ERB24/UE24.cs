...
namespace ABT.Test.TestExecutive.Switching.USB_ERB24 {
        ...
        // NOTE:  UE enum is a static definition of TestExec's MCC USB-ERB24(s).
        ...
        //  - Specify MCC USB-ERB24s in TestExec.GlobalConfigurationFile.
    ...
    // TODO:  Eventually; change UE24 from a singleton to a static class; consistent with ABT.Test.TestExecutive.SCPI_VISA_Instruments namespace classes.
    public sealed class UE24 {
        ...
        private static DigitalPortType GetPort(R r) {
            switch (r) {
                ...
                default: throw new NotImplementedException(TestExec.NotImplementedMessageEnum(typeof(R)));
            }
        }
