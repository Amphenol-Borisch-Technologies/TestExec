...
using static ABT.Test.TestExecutive.SCPI_VISA_Instruments.Keysight;
...
namespace ABT.Test.TestExecutive.SCPI_VISA_Instruments {
    public static class PS_E36103B { public const String MODEL = "E36103B"; } // PS_E36103B needed only in class TestExec.AppConfig.SCPI_VISA_Instrument.

    public static class PS_E36105B { public const String MODEL = "E36105B"; } // PS_E36105B needed only in class TestExec.AppConfig.SCPI_VISA_Instrument.
        ...
        public static Double Get(SCPI_VISA_Instrument SVI, PS_DC DC) {
            ...
            switch (DC) {
                ...
                case PS_DC.Volts:
                    ...
                    return voltsDC;
                default:
                    throw new NotImplementedException(TestExec.NotImplementedMessageEnum(typeof(PS_DC)));
            }
        }
