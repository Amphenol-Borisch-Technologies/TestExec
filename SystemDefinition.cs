...
namespace ABT.Test.TestExec {
    ...
    public class SystemDefinition {
        ...
        [XmlElement(nameof(Instruments))] public InstrumentsSystem Instruments { get; set; }
    ...
    public class InstrumentsSystem {
        [XmlElement(nameof(Instruments))] public List<InstrumentSystem> Instruments { get; set; }
        [XmlAttribute(nameof(Folder))] public String Folder { get; set; }
