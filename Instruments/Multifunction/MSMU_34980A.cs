...
namespace ABT.Test.TestExecutive.Instruments.Multifunction {
    ...
    public class MSMU_34980A {
        ...
        //public MSMU_34980A(Instrumentation.Alias id, String description, String address, String className) : base(address) {
        ...
        public String SystemType(SLOTS Slot) { return Query($":SYSTem:CTYPe? {(Int32)Slot}").Replace("\"", "").Split(",")[(Int32)Instrumentation.IDN_FIELDS.Model]; }
